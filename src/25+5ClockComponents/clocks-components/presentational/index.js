        ...
        <div className='clock-container'>
            <div id='top-section'>
                <div id='break-label'>
                    ...
                    <div className='controls-div'>
                        <button id='break-increment' onClick={props.handleClicks} disabled={props.breakIncrement}><FaAngleDoubleUp /></button>
                        <button id='break-decrement' onClick={props.handleClicks} disabled={props.breakDecrement}><FaAngleDoubleDown /></button>
                    </div>
                </div>
                <div id='session-label'>
                    ...
                    <div className='controls-div'>
                        <button id='session-increment' onClick={props.handleClicks} disabled={props.sessionIncrement}><FaAngleDoubleUp /></button>
                        <button id='session-decrement' onClick={props.handleClicks} disabled={props.sessionDecrement}><FaAngleDoubleDown /></button>
                    </div>
                </div>
            </div>
            <div id='clock-section'>
                <div id='clock-top'>
                    ...
                    {/* <div id='time-left'>{props.timer < 10 ? '0'+props.timer : props.timer}</div> */}
                    {/* <div id='time-left'>{props.timer == '00:00' ? props.sessionTime+':00' : props.timer}</div> */}
